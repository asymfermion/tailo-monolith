...
| AI invocation      | `Google Vertex AI (Gemini)` via Edge Functions | Keeps secrets and prompt logic off the phone; provider isolated in `packages/ai` |
...
| Date       | Change                                                                                                                                                                                                                                                                                                                                      |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-29 | Pet portrait cloud sync: `upload-portrait` action in `api-pet`, public `pet-portraits` Storage bucket (`{app_user_id}/portrait.jpg`), signed upload URL flow; `LocalPetProfile` gains `portraitCloudUrl` sync-state flag; portrait restored on new device via `pullRemotePetProfile`; migration `20260629120000_add_pet_portrait_cloud.sql` |
